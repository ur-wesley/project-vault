      ...
      <DialogContent class="sm:max-w-md">
        <DialogHeader>
          <DialogTitle class="flex items-center gap-2">
            <span class="iconify mdi--import h-5 w-5 shrink-0 text-primary" aria-hidden="true" />
            {props.t("locations.importTitle")}
          </DialogTitle>
          <DialogDescription>{props.t("locations.importDescription")}</DialogDescription>
        </DialogHeader>

        <div class="space-y-4 py-4">
          <div class="space-y-1.5">
            <p class="text-[10px] uppercase font-black text-muted-foreground tracking-widest">
              {props.t("locations.importSourcePath")}
            </p>
