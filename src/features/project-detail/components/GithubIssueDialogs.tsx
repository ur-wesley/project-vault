    ...
    <>
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {props.github && !forceLocal()
                ? props.t("projectDetail.submitIssueToDescription", {
                  ...
                  {(l) => (
                    <button
                      ...
                      class={cn(
                        ...
                        props.selectedLabels.includes(l.name)
                          ? "opacity-100"
      ...
      <Dialog open={!!props.editIssue} onOpenChange={(o) => !o && props.setEditIssue(null)}>
        <DialogContent class="max-w-xl">
          <DialogHeader>
            <DialogTitle>
              {props.t("projectDetail.editIssue", { number: props.editIssue?.number ?? 0 })}
            </DialogTitle>
          </DialogHeader>
          <div class="flex flex-col gap-4 py-4">
            <TextField class="grid gap-2">
